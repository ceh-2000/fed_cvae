...
class ConditionalDecoder(nn.Module):
    ...
    def __init__(self, image_size, num_classes, num_channels, z_dim):
        ...
        self.model = nn.Sequential(
            ...
            nn.BatchNorm2d(32, 1.0e-3),
            nn.ReLU(True),
            nn.ConvTranspose2d(32, num_channels, 4, 2, 1),  # B, nc, input_size, input_size
        )
...
if __name__ == "__main__":
    ...
    num_channels = 1
    z_dim = 50
    summary(ConditionalDecoder(img_size, num_classes, num_channels, z_dim).model, (1, (z_dim + num_classes)))
