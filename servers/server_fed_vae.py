...
class ServerFedVAE(Server):
    ...
    def train(self):
        for e in range(self.glob_epochs):
            ...
            self.qualitative_check(e, self.decoder)  # Swap out decoder for any decoder
    ...
    def save_images(self, images, sigmoid, glob_iter, **kwargs):
        """
        ...
        :param **kwargs: Information about image grid layout
        """
        ...
        if glob_iter and self.writer:
            ...
            self.writer.add_image("Reconstructed Images", grid, glob_iter)

    def qualitative_check(self, e, dec):
        """
        ...
        self.save_images(
            novel_imgs, True, glob_iter=e, writer=self.writer, nrow=self.num_classes
        )
