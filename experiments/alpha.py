...
if __name__ == "__main__":
    ...
    default_scripts_dict = {
        ...
        "fed_vae_dataset=mnist": "python3 ../main.py --algorithm fedvae --dataset mnist --num_users 10 --sample_ratio 0.5 --glob_epochs 1 --local_epochs 15 --local_LR 0.001 --z_dim 10 --beta 1.0 --classifier_train_samples 5000 --classifier_epochs 10 --decoder_train_samples 5000 --decoder_epochs 7 --decoder_epochs 0.01 --use_adam 1 --should_log 1",
        # FashionMNIST
