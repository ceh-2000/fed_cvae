...
if __name__ == "__main__":
    ...
    algorithms = ["onefedvae"]
    default_script = (
        f"python3 ../main.py --should_log 1 --num_users 10 --glob_epochs 1 --alpha 0.05"
    )
    ...
    create_shell_files(all_scripts, hosts, "security")
